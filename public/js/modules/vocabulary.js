...
var serviceHTTP = {
  ...
  "delete": function _delete(url) {
    return axios__WEBPACK_IMPORTED_MODULE_0___default()["delete"](url).then(function (response) {
      return response.data;
    })["catch"](function (error) {
      return error;
    });
...
Vue.createApp({
  ...
  methods: {
    handleReset: function handleReset() {
      this.formData = _objectSpread({}, this.resetFormData);
      this.$refs.inputFile.value = null;
      this.formError = {};
    },
    storeVocabulary: function storeVocabulary() {
      var that = this;
      _service_serviceHTTP_js__WEBPACK_IMPORTED_MODULE_0__["default"].post('/admin/api/vocabulary/store', _objectSpread({}, that.formData)).then(function (response) {
        if (response.status == 200) {
          ...
          that.formError = _objectSpread({}, response.message);
        }
      });
    },
